...
public class MoneyFormatUtil {
    ...
    public static String fromatDecimal(String value) {
        ...
        return ArithUtil.thousandCharacterformat(
                new BigDecimal(value).doubleValue(), 2);
    }

    public static String formatDecimal(double value) {
        return ArithUtil.thousandCharacterformat(value, 2);
    }
    ...
    public static String fromatDecimal(BigDecimal value) {
        ...
        return ArithUtil.thousandCharacterformat(value.doubleValue(), 2);
    }

    // 页面格式化金额工具
    public static String fromatDecimalDown(BigDecimal value) {
        if (null == value) {
            return "";
        }
    ...
    // 页面格式化百分比
    public static String fromatDecimalIncome(BigDecimal value) {
        if (null == value) {
            return "";
        }
        value = value.multiply(BigDecimal.valueOf(100)).setScale(2, BigDecimal.ROUND_DOWN);
        return value.toString();
    }
    ...
    public static String formatSplit(String value) {
        if (value == null || value.isEmpty()) {
            return null;
        }
        return ArithUtil.thousandCharacterformat(Double.valueOf(value), 0);
    }

    public static String splitInteger(BigDecimal value) {
        if (value == null) {
            return null;
        }
        String v = value.toString();
        int beginIndex = v.indexOf(".");
        if (beginIndex != -1) {
            return v.substring(0, beginIndex);
        }
        return v;
    }

    public static String splitDecimal(BigDecimal value) {
        if (value == null) {
            return null;
        }
        String result = "";
        ...
        if (beginIndex == -1) {
            ...
            result = v.substring(beginIndex + 1, endIndex);
        }
        return result;
    }
    
    //页面格式化方法小数点保留4位
    public static String formatDecimal4(BigDecimal value) {
    	if (null == value) {
            return "";
        }
    	return ArithUtil.thousandCharacterformat(value.doubleValue(), 4);
    }
    
    public static String formatDecimal4(String value) {
        if (StringUtils.isEmpty(value)) {
            return "";
        } else if (value.equals("-")) {
            return value;
        ...
        return ArithUtil.thousandCharacterformat(
                new BigDecimal(value).doubleValue(), 4);
    }
